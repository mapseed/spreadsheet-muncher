...
TargetCategory = 'Quality of Life'

#Open the files using 'with' to make sure they close no matter what, assign the files to the variables csvinput, csvoutput
with open('Georgetown_Import.ods_GT_Matrix.csv', 'r') as csvinput, open('QualComp.csv', 'w') as Compcsvoutput, open('QualProg.csv', 'w') as Progcsvoutput, open('QualDead.csv', 'w') as Deadcsvoutput:
